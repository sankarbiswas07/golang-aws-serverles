...
import(
	...
	"github.com/sankarbiswas07/golang-aws-serverles/pkg/validators"
)
...
func UpdateUser(req events.APIGatewayProxyRequest, tableName string, dynaClient *dynamodb.DynamoDB)(*User, error){
	var u User
	if err := json.Unmarshal([]byte(req.Body), &u); err !=nil {
		return nil, errors.New(ErrorInvalidEmail)
	}
